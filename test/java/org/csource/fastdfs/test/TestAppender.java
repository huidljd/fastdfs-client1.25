  	...
  	try
  	{
  		...
  		*/
  		...
  		System.out.println("file length: " + file_buff.length);
			...
			group_name = null;
			StorageServer[] storageServers = tracker.getStoreStorages(connection, group_name);
  		...
  		*/
  		...
  		else
  		{
  			...
  			System.err.println(client.get_file_info(group_name, remote_filename));
				...
				servers = tracker.getFetchStorages(connection, group_name, remote_filename);
				if (servers == null)
				{
  		...
  		if (results != null)
  		{
  			...
  			inetSockAddr = connection.getInetSocketAddress();
  			...
  			String filename = "c:\\" + remote_filename.replaceAll("/", "-");
  			errno = client.download_file(group_name, remote_filename, 0, 0, new DownloadFileWriter(filename));
  			if (errno == 0)
  			{
  				System.err.println("Download file success");
  			}
	    ...
	    else
	    {
  		...
  		storageServer = tracker.getFetchStorage(connection, group_name, remote_filename);
  		if (storageServer == null)
  		{
