...
import org.csource.fastdfs.conn.pool.TrackerConnectionManager;
...
*/
	public static class Uploader
	{
		...
		public ConnectionSupplier connection;
  	...
  	public int uploadFile() throws Exception
  	{
	  	...
	  	catch(Exception ex)
	  	{
	  		...
	  		TrackerConnectionManager.INSTANCE.returnConnection(connection.getInetSocketAddress(),connection);
	  		TrackerConnectionManager.INSTANCE.dumpPoolInfo(connection.getInetSocketAddress());
	  	}
  	}
	}
...
*/
	public static class Downloader
	{
		...
		{
  		this.tracker = new TrackerClient();
  		this.connection = tracker.getConnection();
...
*/
	...
	{
		private int thread_index;
		private final Integer counter_lock = new Integer(0);
